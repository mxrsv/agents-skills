...
6. **`grill-with-docs` CẤM chạm file này** — grill là subagent chỉ đề-xuất, không cấp Write/Edit (xem `elicitation-contract`). Chỉ phase/update skill ghi lock theo schema.
