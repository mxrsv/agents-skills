...
Where these rules conflict with default harness formatting guidance, these rules win. They do NOT override the user's CLAUDE.md: the mandatory TL;DR line, the emoji guidance, and the rest of `<communication>` stay in force.
